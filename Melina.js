cfg.Light, cfg.Portrait, cfg.Share;
...
function OnAuthResult( isConfirmed, errorMessage )
{
    ...
    alert("Motherfucker, you don't have access.");
    app.Exit( true );
    }
		}
...
{
    layContent = app.CreateLayout( "Card", "VCenter,FillXY" );
...
function CreateDrawer()
{
	...
	var img = app.CreateImage( "Img/Melina.png", 0.325 );
	img.SetMargins( 0.02,0.02,0.02,0.01 );
	layDrawerTop.AddChild( img );
	
	//Add app name to top layout.
	var txtName = app.CreateText( "Melina Leon",-1,-1,"Bold");
